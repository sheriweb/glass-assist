...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            <x-pages.header title="Edit Event" back="archive.vehicle-maintenance-events"/>

            <x-forms.form route="{{ route('archive.edit-vehicle-maintenance-event', $event->id) }}">
                @method('PUT')
                ...
                <x-forms.select id="service-type" :options="$types" label="Service Type" :selected="$event->service_type" name="service_type"/>
