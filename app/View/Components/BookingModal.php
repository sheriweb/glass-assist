...
{
    /** @var object[] $calendarTypes */
    private $calendarTypes;
    /** @var object[] $customerTitles */
    private $customerTitles;
    /** @var object[] $cardItemTypes */
    private $cardItemTypes;
    /** @var object[] $paymentTypes */
    private $paymentTypes;
    /** @var object[] $jobNotCompletedReasons */
    private $jobNotCompletedReasons;
    /** @var object[] $jobStatuses */
    private $jobStatuses;
     ...
     * @param WhatWindscreenApiService $whatWindscreenApiService
     */
    public function __construct(
        ...
        WhatWindscreenApiService $whatWindscreenApiService
    ) {
    ...
    public function render()
    {
        ...
        $glassPositions = $this->whatWindscreenApiService->glassPositions();
